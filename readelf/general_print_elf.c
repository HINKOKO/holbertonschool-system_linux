...
/**
 * print_elf32 - print the ELF file with 32bits logic
 * @elf32: Elf32_Ehdr struct bytes containing informations
 * about the ELF file we are rendering
*/

void print_elf32(Elf32_Ehdr elf32)
{
	print_OS_ABI_32(elf32.e_ident);
	print_type_32(elf32.e_type);
	print_architecture_32(elf32.e_machine);
	print_file_version_32(elf32.e_version);
	print_entrypt_32(elf32.e_entry);
	print_start_sections_32(elf32);
	print_flags_32(elf32.e_flags);
	print_header_infos_32(elf32);
}
